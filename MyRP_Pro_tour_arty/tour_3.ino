void tour_3()
  {
    ...
    servo(29, 60);
    servo(1, 60);
    fline_2sensor(30, 30, 0.35, 0, "3:4","a1", 's', 30);
    move_F_center(220);
    do{Motor(-20,1);}while(mcp_b(5)>md_mcp_b(5));
    bline_2sensor(15, 15, 0.35, 48, "5:6","27", 's', 25); 
    Songnang(); //------>> หลังจากวางแล้วเดินออกมาหยุดตรงรถสามล้อ

    
    fline_2sensor(45, 45, 0.35, 35, "3:4","a1", 's', 1);
    fline_2sensor(20, 20, 0.35, 0, "3:4","a1", 's', 5);
    move_F_center(220);
    do{Motor(-20,1);}while(mcp_b(5)>md_mcp_b(5));
    ...
    move_F_center(200);
    T_right_sensor_F(20, 3);
    fline_2sensor(20, 20, 0.35, 37, "2:3","a6", 's', 30);
