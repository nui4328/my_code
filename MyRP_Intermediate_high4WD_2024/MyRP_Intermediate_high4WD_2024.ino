...
//\\------------------------------------------->>>>>  เขียนโค๊ดหุ่นยนต์ที่นี้
      ...
      speed_rotate = 90;           //------------>>  ตั้งความเร็วในการหมุน ซ้ายขวา
      rotate_right = 850;           //------------>>  ตั้งค่า องศา ในการหมุน ขวา 
      rotate_left = 1100;           //------------>>  ตั้งค่า องศา ในการหมุน ซ้าย
      
      rotate_color = 1100;           //------------>>  ตั้งค่า องศา ในการหมุน ซ้าย หลังจากที่ถอยออกมา
      while(1)
        {
